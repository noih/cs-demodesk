...
База данных не используется. Настройки, задачи экспорта и кэши анализа хранятся в файлах, по умолчанию в `demodesk-data/` рядом с исполняемым файлом. Папку данных можно изменить в настройках. Демо остаются на исходных местах: их можно добавлять по одному или находить сканированием выбранных папок.
