...
const ThemeContext = createContext({ appearance: 'dark' as Appearance, colors: THEMES.dark, toggle: () => {} });
...
export function AppTheme({ children }: { children: ReactNode }) {
  ...
  return <ThemeContext.Provider value={{ appearance, colors, toggle }}><Theme panelBackground="solid" appearance={appearance} accentColor="amber" grayColor="slate" radius="small" scaling="100%"><style>{themeCss}{headerCss}</style><div className="app-root">{children}</div></Theme></ThemeContext.Provider>;
}
