...
pub static CUSTOM_PLAYER_PROP_IDS: phf::Map<&'static str, u32> = phf_map! {
    ...
    "usercmd_buttons_held" => USERCMD_BUTTONS_HELD,
    "usercmd_buttons_pressed" => USERCMD_BUTTONS_PRESSED,
    "usercmd_buttons_released" => USERCMD_BUTTONS_RELEASED,
...
pub static TYPEHM: phf::Map<&'static str, PropType> = phf_map! {
    ...
    "usercmd_buttons_held" => PropType::Player,
    "usercmd_buttons_pressed" => PropType::Player,
    "usercmd_buttons_released" => PropType::Player,
